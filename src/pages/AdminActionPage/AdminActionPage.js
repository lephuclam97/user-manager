...
import { actAddUsersRequest, actGetUsersRequest } from "./../../actions/index";
...
class AdminActionPage extends Component {
  ...
  componentDidMount() {
    ...
    if (match) {
      ...
      console.log("adminAcPage componentDidMount OnEdit");
  ...
  onSave = e => {
    ...
    let { id, txtAge, txtDate, txtName, txtRole, checkAction } = this.state;
  ...
  render() {
    let { txtAge, txtDate, txtName, txtRole, checkAction } = this.state;
